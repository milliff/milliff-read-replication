...
packages <- c("tidyverse", "estimatr", "modelsummary", "did", "did2s", "DRDID", "staggered", "fixest", "DIDmultiplegt", "didimputation", "tayloRswift", "kableExtra") # list of packages to load
